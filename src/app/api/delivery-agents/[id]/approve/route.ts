...
// PUT /api/delivery-agents/[id]/approve - Approve a delivery agent
export async function PUT(
  ...
  try {
    ...
    console.log('✅ Delivery agent approved successfully:', agentId);
    ...
    return NextResponse.json({
      ...
      deliveryAgent: {
        ...
        status: updatedAgent.status?.toLowerCase() || 'approved',
