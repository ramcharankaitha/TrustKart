...
-- ==============================================
-- STEP 9: Show table summary (if table has data)
-- ==============================================
DO $$ 
BEGIN
    IF EXISTS (SELECT 1 FROM shop_documents LIMIT 1) THEN
        RAISE NOTICE 'Table contains data. Summary:';
        PERFORM 1; -- Placeholder for summary query
    ELSE
        RAISE NOTICE 'Table is empty (no documents yet)';
    END IF;
END $$;
